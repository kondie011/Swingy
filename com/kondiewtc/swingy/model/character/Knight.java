...
public class Knight extends Character implements Hero
{

    public Knight(String name, String heroClass, int level, int exp, Weapon weapon, Armor armor, int hitP, Position position) {
