...
public class Mage extends Character implements Hero {

    public Mage(String name, String heroClass, int level, int exp, Weapon weapon, Armor armor, int hitP, Position position) {
